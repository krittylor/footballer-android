...
public class DateTimePickerRed extends LinearLayout {
    ...
    public DateTimePickerRed(Context context) {
        this(context, null);
    }

    public DateTimePickerRed(Context context, AttributeSet attrs){
        this(context, attrs, R.attr.layout);
    }

    public DateTimePickerRed(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        int selectedColor = Color.rgb(255, 0, 0);
    ...
    private void populateTimes(){
        ...
        for(int i = 5; i < 12; i++){
            String apm = i < 12 ? "AM" : "PM";
            timeItems.add(new SwipeItem(String.valueOf(i), "", String.valueOf(i) + ":00 " + apm));
        }
