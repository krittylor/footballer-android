...
class DayAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    private DayAdapter(Builder builder) {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        LinearLayout layout = (LinearLayout) View.inflate(context, R.layout.swipeselector_content_day_item, null);
        ...
        if(currentIndex == position){
            ...
            title.setTextColor(deselectedColor);
        ...
        layout.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                if(currentView != null){
                    TextView title = (TextView) currentView.findViewById(R.id.swipeselector_content_title);
                    title.setTextColor(deselectedColor);
                    TextView description = (TextView) currentView.findViewById(R.id.swipeselector_content_description);
                    description.setTextColor(deselectedColor);
                }
                TextView title = (TextView) v.findViewById(R.id.swipeselector_content_title);
                title.setTextColor(selectedColor);
    ...
    static class Builder {
        ...
        private int selectedColor = Color.rgb(0, 0, 255);
        private int deselectedColor = Color.rgb(0, 0, 0);
