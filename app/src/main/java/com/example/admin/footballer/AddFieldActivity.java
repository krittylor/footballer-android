...
public class AddFieldActivity extends BaseActivity implements IPickResult, OnConnectionFailedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addFieldButton.setOnClickListener(onAddFieldListener);
    ...
    private View.OnClickListener onPickLocationListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            try{
                startActivityForResult(builder.build(AddFieldActivity.this), 2);
            } catch (Exception e){
                Toast.makeText(AddFieldActivity.this, "Something went wrong with map api", Toast.LENGTH_LONG).show();
            }
        }
    };
        ...
        public void onClick(View v) {
            ...
            uploadTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Toast.makeText(AddFieldActivity.this, "Uploading photo failed", Toast.LENGTH_SHORT).show();
                }
            });
        }
    };

    private View.OnClickListener onAddFieldListener = new View.OnClickListener(){
        ...
        public void onClick(View v) {
            ...
            FirebaseUtil.getFieldsRef().push().setValue(field.toMap()).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(AddFieldActivity.this, "Adding field failed", Toast.LENGTH_LONG).show();
                }
            });
        }
    };
